...
public class Question extends Model {
  ...
  /**
  *Constructor de la clase Question sin parametros
  **/
  public Question(){
  ...
  /**
  *Constructor de la clase Question con parametros
  **/
  ...
  public  boolean validateA(int n){ return n == (int)this.get("correct_a"); }
}